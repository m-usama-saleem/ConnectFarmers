                            ...
                            <li role="menuitem">
                                <button type="button" className="p-link" tabIndex="0">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-summary">New Products</div>
                                        <div className="notification-detail">You have won <strong>3</strong> new products.</div>
                                    </div>
                                </button>
                            </li>
                            <li role="menuitem">
                                <button type="button" className="p-link">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-summary">Win</div>
                                        <div className="notification-detail">You have won<strong>3</strong> placed bids.</div>
                                    </div>
                                </button>
                            </li>                           
                        </ul>
