...
{
    public class ConnectFarmerCryptography
    {
        private static ConnectFarmerCryptography _instance;
        private static readonly ReaderWriterLockSlim _lock = new ReaderWriterLockSlim();
        private byte[] keyArray;

        public static ConnectFarmerCryptography Instance
        {
            get
            {
                return _instance;
        ...
        private ConnectFarmerCryptography(string key)
        {
        ...
        public static void Initialize(string key)
        {
            try
            {
                ...
                if (_instance == null)
                {
                    _instance = new ConnectFarmerCryptography(key);
                }
            }
            finally
            {
